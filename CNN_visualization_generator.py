...
batch=next(validation_generator)  # returns the next batch of images and labels 
test_x = batch[0]
test_y = np.argmax(batch[1], axis = -1)

indexs = np.argmax(model.predict(test_x), axis=-1) != test_y
